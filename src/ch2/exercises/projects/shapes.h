...
class EqualSidedPolygon : public Polygon {
    double side_length;
    int num_sides;

public:
    EqualSidedPolygon(double side, int num_sides)
...
class Pentagon final : public EqualSidedPolygon {
public:
    explicit Pentagon(double side)
        : EqualSidedPolygon(side, 5) {
    }
};

class Hexagon final : public EqualSidedPolygon {
public:
    explicit Hexagon(double side)
        : EqualSidedPolygon(side, 6) {
    }
};

class Octagon final : public EqualSidedPolygon {
public:
    explicit Octagon(double side)
        : EqualSidedPolygon(side, 8) {
    }
};
